...
#### Illustrative Scenario: Anatomy of a Save
To illustrate this, consider a representative scenario involving a critical cooling tower fan.
*   **The Signal:** A wireless vibration sensor flags a slight increase in overall vibration (from 0.15 to 0.22 in/sec). A generic alarm would ignore this as "acceptable." However, the reliability engineer performs a spectrum analysis and notices a low-amplitude peak at the Gear Mesh Frequency (GMF) of the gearbox.
*   **The Diagnosis:** Crucially, the GMF peak has "sidebands" spaced at the speed of the input shaft. This specific pattern—sidebands around the mesh frequency—is the fingerprint of a misaligned or worn pinion gear.
*   **The Decision:** The team estimates several weeks of remaining life. They order a replacement gearbox and schedule a crane for a planned outage.
*   **The ROI Principle:**
    *   *Reactive Scenario:* If the gearbox seizes, the fan could shatter, destroying the stack. Emergency costs including rental equipment, rush shipping, and unplanned production throttle can easily reach six figures.
    *   *Planned Scenario:* Parts, crane rental, and labor at standard rates typically represent a fraction of emergency costs.
    *   *The Save:* The cost difference between planned and reactive maintenance on critical rotating equipment often represents 5-10x savings.
This type of analysis demonstrates the power of translating signal to value. Individual results vary based on equipment criticality and facility operations.
