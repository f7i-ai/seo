import type { RTInlineNode, RTNode, RichTextField, RichTextNodeTypes } from "@prismicio/client";
 ...
 */
export type RichTextHTMLMapSerializerFunction = (payload: RichTextHTMLMapSerializerFunctionPayload) => RichTextHTMLMapSerializerShorthand | RTNode | RTInlineNode | RTPartialInlineNode | undefined;
/**
 ...
 */
export declare const htmlAsRichText: (html: string, config?: HTMLAsRichTextConfig) => HTMLAsRichTextReturnType;
export {};
