...
import type { ContentRelationshipField, EmptyContentRelationshipField } from "../types/value/contentRelationship";
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
export declare const contentRelationship: <Field extends ContentRelationshipField>(field: Field | null | undefined) => field is Exclude<Field, EmptyContentRelationshipField>;
/**
